...
export type OUIProtocolEvent = {
    ...
    payload: OUISurfaceRegistration;
} | {
    type: 'surface:deregister';
    payload: OUISurfaceDeregistration;
} | {
    type: 'action:request';
    payload: OUIActionRequest;
} | {
    type: 'action:result';
    payload: OUIActionResult;
} | {
    type: 'observation:update';
    payload: OUIObservationUpdate;
};
/**
 * Protocol event type strings (for type guards and routing).
 */
export declare const OUI_PROTOCOL_EVENTS: {
    readonly SURFACE_REGISTER: "surface:register";
    readonly SURFACE_DEREGISTER: "surface:deregister";
    readonly ACTION_REQUEST: "action:request";
    readonly ACTION_RESULT: "action:result";
    readonly OBSERVATION_UPDATE: "observation:update";
};
